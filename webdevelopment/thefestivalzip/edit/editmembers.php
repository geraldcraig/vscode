...
$(document).ready(function() {
  ...
  <body>
                              ...
                              <!-- <form action='emailtest.php' method='POST'>
                                ...
                                <td class='text-center'><button type='submit' class='adminbutton' name='acceptapp'><i class='icon-ok-circled applicationtick'></i></button></td>
                              </form> -->
                      ...
                      <?php
                        ...
                        echo " <tr>
                                ...
                                <tr>
                                  <td>
                                    <form action='memberprocess.php' method='POST'>
                                      <div class='form-row'>
                                      <div class='form-group col-5'>
                                      <select class='form-control overflow-auto' name='instrumentref'>
                                ...
                                echo "</select>
                                    ...
                                    <div class='form-group col-5'>
                                      <input type='text' class='form-control' name='membername' id='exampleInputEmail1' aria-describedby='emailHelp'>
                                    </div>
