                                    ...
                                    <td>
                                      <form action='newseditprocess.php' method='POST'>
                                        ...
                                        <div class='card-body' id='newscards'>
                                          ...
                                          <input type='text' class='form-control' name='seemorelinkedit' value='$url' aria-label='URL goes here' aria-describedby='basic-addon1'>
                                        </div>
                                        <button type='submit' class='btn btn-outline-success' name='updatenewsstory'><i class='icon-ok-circled'></i></button>
                            ...
                            echo "<tr>
                                    <td>
                                      ...
                                      <div class='card-body' id='newscards'>
                                        ...
                                        <a href='$url' class='btn d-flex d-flex justify-content-end'>See More</a>
                                      </div>
                                      ...
                                      <form action='newseditprocess.php' method='POST'>
                                        <input type='hidden' value='$news' name='newsid'/>
                                        <button type='submit' class='d-inline btn btn-outline-danger float-right mr-3' name='deletestory'><i class='icon-cancel-circled applicationcross'></i></button>
                                      </form>
                                    </td>  
                                  </tr>";
                          }
