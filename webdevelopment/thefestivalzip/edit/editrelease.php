                      ...
                      <div class='p-3 mb-2 bg-light text-dark'>Latest Release</div>
                        ...
                        <div class='form-row'>
                          <div class='form-group col'>
                            ...
                            <input type='text' class='form-control' name='albumtitle' value='$albumtitle'>
                          </div>
                        </div>
                        ...
                        <div class='p-3 mb-2 bg-light text-dark'>Release Date</div>
                          <div class='form-row'>
                            <div class='form-group col-md-6'>
                              ...
                              <input type='text' class='form-control' name='releasemonth' value='$releasemonth'>
                            </div>
                            <div class='form-group col-md-6'>
                              <label for='inputEmail4'>Year</label>
                              <input type='text' class='form-control' name='releaseyear' value='$releaseyear'>
                            </div>
                          </div>
