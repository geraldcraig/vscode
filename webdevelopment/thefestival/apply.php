      ...
      <form class ="artistapply" method="POST" action="applydetail.php" enctype="multipart/form-data" novalidate>
        ...
        <div class="form-row">
          <div class="form-group col">
            ...
            placeholder="<?php if(isset($isinvalidall)) {echo "$bandph ";} else { echo "Band Name";} ?>" required>
          </div>
        </div>
        ...
        <div class="form-row">
          <div class="form-group col">
            ...
            placeholder="<?php if(isset($isinvalidall) || isset($isinvalid1)) {echo "$emailph ";} 
            else { echo "bandname@bfestival.com"; }?>" required>
        ...
        <div class="form-row">
          ...
          <label for="inputEmail4">Genre</label>
            ...
            overflow-auto" name="genreref">
              ...
              {echo "$genreph ";} else { echo "Genre";} ?></option>
                <?php 
        ...
        <div class="form-row">
          ...
          <label for="inputEmail4">Upload a Bio Image</label>
            <div class="custom-file">
              ...
              for="inputGroupFile02" aria-describedby="inputGroupFileAddon02">
              <?php if(isset($isinvalidall) || isset($isinvalid1) || isset($isinvalid2) || isset($isinvalid3)) 
              {echo "Choose File";} else { echo "Choose File";} ?></label>
            </div>
        ...
        <div class="form-row">
          <div class="form-group col">
            ...
            || isset($isinvalid4)) {echo "$bio";} else { echo "enter your bio..."; } ?>"
            required></textarea>
          </div>
        </div>
        ...
        <div class="form-row">
          <div class="form-group col">
            ...
            placeholder="<?php if(isset($isinvalidall) || isset($isinvalid1) || isset($isinvalid2) || isset($isinvalid3) 
            || isset($isinvalid4) || isset($isinvalid5)) {echo "$url";} else { echo "https://www.myband.co.uk";}?>" id="bandsite" 
