    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      ...
      <?php
        ...
        if(!isset($_SESSION['session'])) {
          ...
          echo "<form action='/thefestival/modules/navbar.php' method='POST'>
          <a class='btn btn-outline-info my-2 my-sm-0 mr-2' href='admin.php'><i class='icon-user-circle'></i>$display</a>
