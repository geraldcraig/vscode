    ...
    <div class="container lineup">
      <div class="accordion" id="accordionExample">
            ...
            <h2 class="mb-0">
              ...
              ?>
                <div class="float-right">
                  <button class="btn btn-link text-dark" id="h1drop" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
        ...
        <!-- section 1 content (Friday content/lineup) -->
                  ...
                  $venuedetails = "SELECT * FROM BVENUE
                  INNER JOIN BADDRESS ON pk_address_id = fk_address_id
                  WHERE pk_venue_id = 100";

                  $venuequery = $conn->query($venuedetails);

                  $row = $venuequery->fetch_assoc();
                  ...
                  <div class='card-body'>
                    <div class='row'>
                      <table class='table table-hover'>
                        <thead class='thead-dark'>
                          <tr>
                            <th width='50%'>$vname<br>$vstreet</th>
                            <th width='50%'></th>          
                          </tr>
                    ...
                    INNER JOIN BADDRESS ON pk_address_id = fk_address_id              
                    WHERE fk_date_id = 400 AND pk_venue_id = 100 ORDER BY start_time DESC";
                    ...
                    while ($row = $fridayquery->fetch_assoc()) {
                      ...
                      echo "<tr data-href='artistbio.php?id=$id'>
                              <td width='50%' scope='row'>$startdisp - $enddisp</td>
                              <td width='50%' scope='row'>$artist</td>
                  ...
                  echo "
                    ...
                    INNER JOIN BVENUE ON fk_venue_id = pk_venue_id               
                    INNER JOIN BADDRESS ON pk_address_id = fk_address_id              
                    WHERE fk_date_id = 400 AND pk_venue_id = 101 ORDER BY start_time DESC";
                  ...
                  echo "
                    ...
                    INNER JOIN BVENUE ON fk_venue_id = pk_venue_id               
                    INNER JOIN BADDRESS ON pk_address_id = fk_address_id              
                    WHERE fk_date_id = 400 AND pk_venue_id = 102 ORDER BY start_time DESC";
      ...
      <div class="card">
        <div class="card-header titlefont" id="headingTwo">
          <h2 class="mb-0">
            ...
            ?>
              <div class="float-right">
                <button class="btn btn-link text-dark" id="h2drop" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
        ...
        <!-- section 2 content (Saturday content/lineup) -->
                <?php
                  ...
                  <div class='card-body'>
                    ...
                    INNER JOIN BVENUE ON fk_venue_id = pk_venue_id               
                    INNER JOIN BADDRESS ON pk_address_id = fk_address_id              
                    WHERE fk_date_id = 401 AND pk_venue_id = 100 ORDER BY start_time DESC";
                  ...
                  echo "
                    ...
                    INNER JOIN BVENUE ON fk_venue_id = pk_venue_id               
                    INNER JOIN BADDRESS ON pk_address_id = fk_address_id              
                    WHERE fk_date_id = 401 AND pk_venue_id = 101 ORDER BY start_time DESC";
                  ...
                  echo "
                    ...
                    INNER JOIN BVENUE ON fk_venue_id = pk_venue_id               
                    INNER JOIN BADDRESS ON pk_address_id = fk_address_id              
                    WHERE fk_date_id = 401 AND pk_venue_id = 102 ORDER BY start_time DESC";
        ...
        <div class="card">
          <div class="card-header titlefont" id="headingThree">
            <h2 class="mb-0"> 
              ...
              ?>
                <div class="float-right">
                  <button class="btn btn-link text-dark" id="h3drop" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
          ...
          <?php
                  ...
                  <div class='card-body'>
                    ...
                    INNER JOIN BVENUE ON fk_venue_id = pk_venue_id               
                    INNER JOIN BADDRESS ON pk_address_id = fk_address_id              
                    WHERE fk_date_id = 402 AND pk_venue_id = 100 ORDER BY start_time DESC";
                  ...
                  echo "
                    ...
                    INNER JOIN BVENUE ON fk_venue_id = pk_venue_id               
                    INNER JOIN BADDRESS ON pk_address_id = fk_address_id              
                    WHERE fk_date_id = 402 AND pk_venue_id = 101 ORDER BY start_time DESC";
                  ...
                  echo "
                    ...
                    INNER JOIN BVENUE ON fk_venue_id = pk_venue_id               
                    INNER JOIN BADDRESS ON pk_address_id = fk_address_id              
                    WHERE fk_date_id = 402 AND pk_venue_id = 102 ORDER BY start_time DESC";
