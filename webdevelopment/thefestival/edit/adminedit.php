...
<html>
  ...
  <head>
    ...
    <title>Add News | B Festival</title>
    <!-- favicon -->
                      ...
                      <td>
                        <form action="addnewsprocess.php" method="POST">
                          ...
                          <div class='row float-right'>
                            <button type='submit' class='btn btn-outline-success mt-1 mr-1' name='addnewsstory'><i class='icon-ok-circled'></i></button>
                            <button type='submit' class='btn btn-outline-danger mt-1 mr-3' name='cancelnews'><i class='icon-cancel-circled'></i></button>
                          </div>  
                          </form>
                      </td>
                    </tr>
