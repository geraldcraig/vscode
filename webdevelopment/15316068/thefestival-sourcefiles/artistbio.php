...
$readartist = "SELECT * FROM BARTIST
WHERE pk_artist_id = $id";
  ...
  <body>
    ...
    <?php
      ...
      echo "<div class='container'>
              <a href='artist.php'><button type='button' class='btn btn-outline-secondary text-uppercase mt-4 mb-4'>
              <i class='icon-left-open'></i>Back to Artist Line-Up</button></a>
              <div class='row'>
                <div class='col'>
                ...
                <div class='col-sm-12 col-md-4 text-left'> 
                  ...
                  while ($row = $result->fetch_assoc()) {
                    ...
                    $genre = $row['genre'];
                      ...
                      echo" 
                              ...
                              <div class='card release mb-4' style='width: 100%;'>
                  ...
                  echo "</div>
                          <div class='col-sm-12 col-md-8 text-left'>
                            ...
                            <p class='biodeets text-break'>$intro</p>
                            <p class='biodeets text-break'>$bio</p>
